...
* Choose background image alignment:
	...
	* Vertical
		...
		* Center
		* Bottom
* Ability to use post title with link
* Ability to hide post title
...
= V1.47 - 11.04.26 =
* PRO : Ability to use Gutenberg block has been updated.
* Update : We updated functionality for WordPress 6.9.4
* Update : BWS plugins section is updated.
* NEW : Ability to use quotes and tips title with link has been added.
* NEW : Ability to hide quotes and tips title has been added.
